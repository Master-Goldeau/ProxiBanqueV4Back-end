...
public class ProxiBanqueServiceImplCompte implements IProxiBanqueServiceCompte {
	private static final Logger LOGGER = LoggerFactory.getLogger(ProxiBanqueServiceImplCompte.class);
